...
public:
  ...
  void Push(T d); // Insert item
  T Get(); // Receive item
  int IsEmpty(void) const; // control empty
  int IsFull(void) const; // override control

  //dop work
  inline int min_elem(); // Search for a minimum item
  inline int max_elem(); // Search for the ultimate item
  inline void file(); // Write to file
